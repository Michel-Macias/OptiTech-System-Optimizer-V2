...
class TestConfigManager(unittest.TestCase):
    ...
    def test_directories_are_created(self, mock_expandvars, mock_exists, mock_makedirs):
        # Asegurarse de que los mocks se pasen correctamente
        # La inicialización del config_manager en setUp ya debería haber llamado a makedirs
        # Verificamos que makedirs fue llamado con las rutas esperadas
